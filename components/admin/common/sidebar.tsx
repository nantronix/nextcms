  ...
  return (
    <div className={`min-w-fit ${sidebarExpanded ? 'sidebar-expanded' : ''}`}>
      ...
      <Transition
        ...
        id="sidebar"
        ref={sidebar}
        className="no-scrollbar lg:sidebar-expanded:!w-64 absolute left-0 top-0 z-40 flex h-[100dvh] w-64 shrink-0 flex-col overflow-y-scroll bg-slate-800 p-4 transition-all duration-200 ease-in-out lg:static lg:left-auto lg:top-auto lg:!flex lg:w-20 lg:translate-x-0 lg:overflow-y-auto 2xl:!w-64"
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="h-6 w-6 shrink-0" viewBox="0 0 24 24">
                              <path
                                className={`fill-current ${segments.includes('ecommerce') ? 'text-indigo-300' : 'text-slate-400'}`}
                                d="M13 15l11-7L11.504.136a1 1 0 00-1.019.007L0 7l13 8z"
                              />
                              <path
                                className={`fill-current ${segments.includes('ecommerce') ? 'text-indigo-600' : 'text-slate-700'}`}
                                d="M13 15L0 7v9c0 .355.189.685.496.864L13 24v-9z"
                              />
                              <path
                                className={`fill-current ${segments.includes('ecommerce') ? 'text-indigo-500' : 'text-slate-600'}`}
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="h-6 w-6 shrink-0" viewBox="0 0 24 24">
                              <path
                                className={`fill-current ${segments.includes('community') ? 'text-indigo-500' : 'text-slate-600'}`}
                                d="M18.974 8H22a2 2 0 012 2v6h-2v5a1 1 0 01-1 1h-2a1 1 0 01-1-1v-5h-2v-6a2 2 0 012-2h.974zM20 7a2 2 0 11-.001-3.999A2 2 0 0120 7zM2.974 8H6a2 2 0 012 2v6H6v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5H0v-6a2 2 0 012-2h.974zM4 7a2 2 0 11-.001-3.999A2 2 0 014 7z"
                              />
                              <path
                                className={`fill-current ${segments.includes('community') ? 'text-indigo-300' : 'text-slate-400'}`}
                  ...
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block truncate text-slate-200 transition duration-150 ${
                          segments.includes('finance') ? 'hover:text-slate-200' : 'hover:text-white'
                        }`}
                        onClick={(e) => {
                          e.preventDefault()
                          expandOnly ? setSidebarExpanded(true) : handleClick()
                  ...
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block truncate text-slate-200 transition duration-150 ${
                          segments.includes('jobs') ? 'hover:text-slate-200' : 'hover:text-white'
                        }`}
                        onClick={(e) => {
                          e.preventDefault()
                          expandOnly ? setSidebarExpanded(true) : handleClick()
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="h-6 w-6 shrink-0" viewBox="0 0 24 24">
                              <path
                                className={`fill-current ${segments.includes('jobs') ? 'text-indigo-600' : 'text-slate-700'}`}
                              ...
                              />
                              <path
                                className={`fill-current ${segments.includes('jobs') ? 'text-indigo-500' : 'text-slate-600'}`}
                              ...
                              />
                              <path
                                className={`fill-current ${segments.includes('jobs') ? 'text-indigo-300' : 'text-slate-400'}`}
                  ...
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block truncate text-slate-200 transition duration-150 ${
                          segments.includes('tasks') ? 'hover:text-slate-200' : 'hover:text-white'
                        }`}
                        onClick={(e) => {
                          e.preventDefault()
                          expandOnly ? setSidebarExpanded(true) : handleClick()
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="h-6 w-6 shrink-0" viewBox="0 0 24 24">
                              <path
                                className={`fill-current ${segments.includes('tasks') ? 'text-indigo-500' : 'text-slate-600'}`}
                              ...
                              />
                              <path
                                className={`fill-current ${segments.includes('tasks') ? 'text-indigo-300' : 'text-slate-400'}`}
              ...
              {/* Messages */}
              <li
                className={`mb-0.5 rounded-sm px-3 py-2 last:mb-0 ${segments.includes('messages') && 'bg-slate-900'}`}
              >
              ...
              {/* Inbox */}
              <li
                className={`mb-0.5 rounded-sm px-3 py-2 last:mb-0 ${segments.includes('inbox') && 'bg-slate-900'}`}
              >
              ...
              {/* Calendar */}
              <li
                className={`mb-0.5 rounded-sm px-3 py-2 last:mb-0 ${segments.includes('calendar') && 'bg-slate-900'}`}
              >
                <SidebarLink href="/calendar">
                  <div className="flex items-center">
                    <svg className="h-6 w-6 shrink-0" viewBox="0 0 24 24">
                      <path
                        className={`fill-current ${segments.includes('calendar') ? 'text-indigo-500' : 'text-slate-600'}`}
                        d="M1 3h22v20H1z"
                      />
                      <path
              ...
              {/* Campaigns */}
              <li
                className={`mb-0.5 rounded-sm px-3 py-2 last:mb-0 ${segments.includes('campaigns') && 'bg-slate-900'}`}
              >
                <SidebarLink href="/campaigns">
                  <div className="flex items-center">
                    <svg className="h-6 w-6 shrink-0" viewBox="0 0 24 24">
                      <path
                        className={`fill-current ${segments.includes('campaigns') ? 'text-indigo-500' : 'text-slate-600'}`}
                        d="M20 7a.75.75 0 01-.75-.75 1.5 1.5 0 00-1.5-1.5.75.75 0 110-1.5 1.5 1.5 0 001.5-1.5.75.75 0 111.5 0 1.5 1.5 0 001.5 1.5.75.75 0 110 1.5 1.5 1.5 0 00-1.5 1.5A.75.75 0 0120 7zM4 23a.75.75 0 01-.75-.75 1.5 1.5 0 00-1.5-1.5.75.75 0 110-1.5 1.5 1.5 0 001.5-1.5.75.75 0 111.5 0 1.5 1.5 0 001.5 1.5.75.75 0 110 1.5 1.5 1.5 0 00-1.5 1.5A.75.75 0 014 23z"
                      />
                      <path
                        className={`fill-current ${segments.includes('campaigns') ? 'text-indigo-300' : 'text-slate-400'}`}
                  ...
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block truncate text-slate-200 transition duration-150 ${
                          segments.includes('utility') ? 'hover:text-slate-200' : 'hover:text-white'
                        }`}
                        onClick={(e) => {
                          e.preventDefault()
                          expandOnly ? setSidebarExpanded(true) : handleClick()
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block truncate text-slate-200 transition duration-150 ${open ? 'hover:text-slate-200' : 'hover:text-white'}`}
                        onClick={(e) => {
                          e.preventDefault()
                          expandOnly ? setSidebarExpanded(true) : handleClick()
                        }}
